...
#include <plat/cpu.h>
    ...
    // odroid DRAM 400MHz fixed...
    #define DMC_400MHZ_FIXED
#endif
...
#ifdef DMC_400MHZ_FIXED
	static unsigned int exynos4412_mif_volt[ASV_GROUP][LV_END] = {
		/* 400      400      267      267      160     133     100 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* RESERVED */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* RESERVED */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV2 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV3 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV4 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV5 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV6 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV7 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV8 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV9 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* ASV10 */
		{1025000, 1025000, 1025000, 1025000, 1025000, 1025000, 1025000}, /* RESERVED */
	};
...
#endif // DMC_400MHZ_FIXED

#ifdef DMC_400MHZ_FIXED
	static unsigned int exynos4x12_timingrow[LV_END] = {
		0x34498691, 0x34498691, 0x34498691, 0x34498691, 0x34498691, 0x34498691, 0x34498691
	};
