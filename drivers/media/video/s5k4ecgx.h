...
enum s5k4ecgx_preview_frame_size {
	...
	S5K4ECGX_PREVIEW_VGA,		/*4 640x480 */
	S5K4ECGX_PREVIEW_D1,		/*5 720x480 */
...
struct s5k4ecgx_regs {
	struct s5k4ecgx_regset_table ev[GET_EV_INDEX(EV_MAX_V4L2)];
	...
	struct s5k4ecgx_regset_table af_pre_flash_start;
	struct s5k4ecgx_regset_table af_pre_flash_end;
	struct s5k4ecgx_regset_table flash_ae_set;
	struct s5k4ecgx_regset_table flash_ae_clear;
	struct s5k4ecgx_regset_table ae_lock_on;
	struct s5k4ecgx_regset_table ae_lock_off;
	struct s5k4ecgx_regset_table awb_lock_on;
	struct s5k4ecgx_regset_table awb_lock_off;
	...
	struct s5k4ecgx_regset_table hd_af_start;
	struct s5k4ecgx_regset_table hd_first_af_start;
...
#define CAPTURE_LOW_LIGHT_LEVEL		0x1D
